...
//
// bank_in_fd            - The input file descriptor the bank will
//                         receive commands from.
// atm_out_fd            - A table of file descriptors that the bank
//                         can send commands to. Each file descriptor
//                         corresponds to a different ATM.
//
