...
// This function is used to record an error and an associated
// message. It is called by the "bank" and "atm" code to indicate
// any unexpected errors.
void error_msg(int error, char *msg);

// This function is used to retrieve the error code set by
// `error_msg`.
int error_type();

// This function is used to retrieve the error message set by
// `error_msg`.
const char* error_msg_str();

// This function is used to print an error message set by
// `error_msg`.
void error_print();
